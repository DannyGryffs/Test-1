...
```
Defining a function sets it's rules and establishes what it will be. Calling to a function is when you'd like that same rule or established action one has initially set to be reused or repeated.
```
